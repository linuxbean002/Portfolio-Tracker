...
if os.path.exists(root_path + '/Daily Data/Portfolio/Portfolio Value.csv') and os.path.exists(
        root_path + '/Daily Data/Portfolio/Portfolio Daily Prices.csv') \
        and os.path.exists(root_path + '/Daily Data/Portfolio/Portfolio Value.csv') and os.path.exists(
    root_path + '/Daily Data/Portfolio/Portfolio Returns.csv') \
        and os.path.exists(root_path + '/Daily Data/Benchmark/Benchmark Price Data.csv') and os.path.exists(
    root_path + '/Daily Data/Benchmark/Benchmark Returns.csv') \
        and os.path.exists(root_path + '/Daily Data/Portfolio/Portfolio Returns.csv'):
    ...
    def fundis(rate, method):
        ...
        if os.path.exists(root_path + '/Daily Data/Portfolio/Portfolio Returns.csv'):
            ...
            if method == "avg":
                ...
                userInDate = str(raw_input("Please enter a date in the YYYY-MM-DD format: "))
                ...
                rf_data = pd.read_csv(
                    'https://www.quandl.com/api/v3/datasets/USTREASURY/YIELD.csv?api_key=37NeVhjr4KhAPxKds_jZ&start_date='+str(rfyear)+'-'+str(rfmonth)+'-'+str(rfday)+'')[rate]
                rf = rf_data.mean() / 100
