...
def portfolio():
    ...
    if os.path.exists(root_path+'/Daily Data/Portfolio/Portfolio Value.csv') and os.path.exists(root_path+'/Daily Data/Portfolio/Portfolio Daily Prices.csv') \
            and os.path.exists(root_path+'/Daily Data/Portfolio/Portfolio Value.csv') and os.path.exists(root_path+'/Daily Data/Portfolio/Portfolio Returns.csv') \
            and os.path.exists(root_path+'/Daily Data/Benchmark/Benchmark Price Data.csv') and os.path.exists(root_path+'/Daily Data/Benchmark/Benchmark Returns.csv'):
...
def asset_performance():
    ...
    if os.path.exists(root_path+'/Daily Data/Portfolio/Portfolio Value.csv') and os.path.exists(root_path+'/Daily Data/Portfolio/Portfolio Returns.csv'):
